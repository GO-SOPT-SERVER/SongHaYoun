package sopt.org.fourthSixSeminar.common.advice;
...
//    }
    ...
    protected ApiResponse handleUnauthorizedException(final Exception e) {

        return ApiResponse.error(Error.TOKEN_TIME_EXPIRED_EXCEPTION,"토큰이 만료되었습니다.");
    }
    /**
     * 500 Internal Server
     */
